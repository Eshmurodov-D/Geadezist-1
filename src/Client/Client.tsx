...
function Client() {
    ...
    const [, setIsExitClicked] = useState(false); // To track if Exit was clicked
    ...
    const dashboardData = {
        ...
        dropdownItems: [
            {
                label: "Профил",
                icon: "https://cdn-icons-png.flaticon.com/128/3135/3135715.png"  // Profile icon
            },
            {
                label: "Чиқиш",
                icon: "https://cdn-icons-png.flaticon.com/128/1828/1828775.png"  // Exit icon
            }
        ],
        card: {
            title: "test",
    ...
    const openModal = () => {
        ...
        setIsModalOpen(true); // Open modal when Exit is clicked
    };
    ...
    const handleLogout = () => {
        navigate("/Register"); // Navigate to Register when Yes is clicked
    };
                        ...
                        <div className="absolute right-0 mt-52 w-80 bg-white shadow-lg rounded-md py-2">
                            {dashboardData.dropdownItems.map((item, index) => (
                                <a
                                    ...
                                    onClick={() => {
                                        if (item.label === "Чиқиш") {
                                            setIsExitClicked(true);  // Set state to true when "Exit" is clicked
                ...
                <div className="fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <div className="flex justify-end space-x-4">
                            <button
                                onClick={closeModal}
                                className="-translate-x-40 px-4 py-2 bg-gray-500 text-white rounded"
                            >
